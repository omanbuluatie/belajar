                    ...
                    <div class="row">
                      <div class="col-auto">
                        <div class="avatar avatar-md avatar-indicators avatar-offline">
                          <img alt="avatar" src="{{ asset('/tpl')}}/assets/images/avatar/avatar-1.jpg" class="rounded-circle" />
                        </div>
                      </div>
                      <div class="col ms-n3">
                    ...
                    <div class="row">
                      <div class="col-auto">
                        <div class="avatar avatar-md avatar-indicators avatar-online">
                          <img alt="avatar" src="{{ asset('/tpl')}}/assets/images/avatar/avatar-2.jpg" class="rounded-circle" />
                        </div>
                      </div>
                      <div class="col ms-n3">
                    ...
                    <div class="row">
                      <div class="col-auto">
                        <div class="avatar avatar-md avatar-indicators avatar-away">
                          <img alt="avatar" src="{{ asset('/tpl')}}/assets/images/avatar/avatar-3.jpg" class="rounded-circle" />
                        </div>
                      </div>
                      <div class="col ms-n3">
                    ...
                    <div class="row">
                      <div class="col-auto">
                        <div class="avatar avatar-md avatar-indicators avatar-info">
                          <img alt="avatar" src="{{ asset('/tpl')}}/assets/images/avatar/avatar-6.jpg" class="rounded-circle" />
                        </div>
                      </div>
                      <div class="col ms-n3">
                    ...
                    <div class="row">
                      <div class="col-auto">
                        <div class="avatar avatar-md avatar-indicators avatar-busy">
                          <img alt="avatar" src="{{ asset('/tpl')}}/assets/images/avatar/avatar-7.jpg" class="rounded-circle" />
                        </div>
                      </div>
                      <div class="col ms-n3">
              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item px-0 pt-0">
                    <div class="row flex-column flex-md-row gap-3 gap-md-0">
                      ...
                      <div class="col-md-3 col-12">
                        <a href="#">
                          <img src="{{ asset('/tpl')}}/assets/images/course/course-laravel.jpg" alt="" class="img-fluid rounded" />
                        </a>
                      </div>
                      <!-- Col -->
                      <div class="col-md-8 col-10">
                        <div class="d-flex flex-column gap-2">
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <img src="{{ asset('/tpl')}}/assets/images/avatar/avatar-7.jpg" alt="" class="rounded-circle avatar-xs" />
                  ...
                  <li class="list-group-item px-0">
                    <div class="row flex-column flex-md-row gap-3 gap-md-0">
                      <div class="col-md-3 col-12">
                        <a href="#"><img src="{{ asset('/tpl')}}/assets/images/course/course-gatsby.jpg" alt="" class="img-fluid rounded" /></a>
                      </div>
                      <div class="col-md-8 col-10">
                        <div class="d-flex flex-column gap-2">
                          <a href="#">
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <img src="{{ asset('/tpl')}}/assets/images/avatar/avatar-8.jpg" alt="" class="rounded-circle avatar-xs" />
                  ...
                  <li class="list-group-item px-0">
                    <div class="row flex-column flex-md-row gap-3 gap-md-0">
                      <div class="col-md-3 col-12">
                        <a href="#">
                          <img src="{{ asset('/tpl')}}/assets/images/course/course-javascript.jpg" alt="" class="img-fluid rounded" />
                        </a>
                      </div>
                      <div class="col-md-8 col-10">
                        <div class="d-flex flex-column gap-2">
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <img src="{{ asset('/tpl')}}/assets/images/avatar/avatar-1.jpg" alt="" class="rounded-circle avatar-xs" />
                  ...
                  <li class="list-group-item px-0">
                    <div class="row flex-column flex-md-row gap-3 gap-md-0">
                      <div class="col-md-3 col-12">
                        <a href="#">
                          <img src="{{ asset('/tpl')}}/assets/images/course/course-wordpress.jpg" alt="" class="img-fluid rounded" />
                        </a>
                      </div>
                      <div class="col-md-8 col-10">
                        <div class="d-flex flex-column gap-2">
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <img src="{{ asset('/tpl')}}/assets/images/avatar/avatar-5.jpg" alt="" class="rounded-circle avatar-xs" />
                ...
                <ul class="list-group list-group-flush list-timeline-activity">
                  ...
                  <li class="list-group-item px-0 pt-0 border-0 mb-2">
                    <div class="row">
                      <div class="col-auto">
                        <div class="avatar avatar-md avatar-indicators avatar-busy">
                          <img alt="avatar" src="{{ asset('/tpl')}}/assets/images/avatar/avatar-4.jpg" class="rounded-circle" />
                        </div>
                      </div>
                      <div class="col ms-n2">
                        <div class="d-flex flex-column gap-1">
