                                        ...
                                        <a class="text-body" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <p class="mb-3">Krisitn Watsan like your comment on course
                                        ...
                                        <a class="text-body" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <p class="mb-3">Just launched a new Courses React for Beginner.
                                                    </p>
                                                    <span class="fs-6">
                                                        <span>
                                                            <span class="fe fe-thumbs-up text-success me-1"></span>
                                        ...
                                        <a class="text-body" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <p class="mb-3">You earn new certificate for complete the
            ...
            <li class="dropdown ms-2">
                <a class="rounded-circle" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown"
                    ...
                    <div class="avatar avatar-md avatar-indicators avatar-online">
                        <img alt="avatar" src="{{ asset('/tpl') }}/assets/images/avatar/avatar-1.jpg"
